...
public class AdapterListViewPontos extends BaseAdapter {
    ...
    public AdapterListViewPontos(Context context, ArrayList<DadosGerais> itens) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view = mInflater.inflate(R.layout.list_item_pontos, null);
